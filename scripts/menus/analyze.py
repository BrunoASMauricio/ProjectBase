...
from processes.versioning import GetDiff, GetFilesDiff, GetDiffForModule, GetFilesDiffForModule
...
AnalysisMenu.AddCallbackEntry("Get files diff for module", GetFilesDiffForModule)
AnalysisMenu.AddCallbackEntry("Get content diff for module", GetDiffForModule)
